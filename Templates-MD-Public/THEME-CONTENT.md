...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| xxx | Updated: DD.MM.YYYY<br>Created: DD.MM.YYYY | [Commit ID](https://github.com/thenocturnaldevgypsy-io/REPO-NAME/), [Commit ID](https://github.com/thenocturnaldevgypsy-io/REPO-NAME/) for [PR ID](https://github.com/thenocturnaldevgypsy-io/REPO-NAME/) | - directory/filename.html<br>- directory/filename.css<br>- directory/filename.js | What was done ([PR ID](https://github.com/thenocturnaldevgypsy-io/REPO-NAME/)) |